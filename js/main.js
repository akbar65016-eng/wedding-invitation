...
const WISH_API = "https://script.google.com/macros/s/AKfycbx5dMy7hVbEp0JZ8Sz3EgK6HMy5i-VJ66d4sQ9C1fEb4fKNuK4o6N3YWq71mUE_SbAy/exec";
let wishPage = 1;
...
formData.append("kehadiran", attend);
...
function renderWishList(wishes) {
  ...
  wishes.forEach((item, i) => {
    const isHadir = String(item.kehadiran).toLowerCase() === "hadir";
